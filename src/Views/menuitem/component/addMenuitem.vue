                    ...
                    <div class="p-8">
                        ...
                        <form id="addItemForm" class="mt-8" method="post" @submit="addMenuitem">
                            <div class="flex flex-col mb-10">
                                    ...
                                    <div class="grid-cols-4 grid">
                                        <div v-for="allergen in allergenen">
                                            <div id="allergeenInfo">
                                                <input id="menuitemAllergens" class="mr-2" type="checkbox"
                                                       @click="getPostAllergens()"/>
                                ...
                                <input type="file" id="itemImage" name="itemImage" accept="image/png, .jpg, .jpeg"
                                       @change="previewImage">
                            ...
                            <button type="submit" class="bg-primary-500 my-2 h-12 rounded p-3">Locatie toevoegen
                            </button>
                        </form>
                    </div>
                </DialogPanel>
                    ...
                    <DialogPanel class="bg-white rounded">
                        ...
                        <div class=" border-2 mt-10 p-2 bg-white m-3" id="menuItemEdit">
                            <form id="addItemForm" class="mt-8" method="post" @submit="editMenuitem">
                                ...
                                <input id="menuitemEditName" placeholder="menuItemEditName" class="rounded border-2 m-2"
                                       name="menuItemEditName">
                                <label>menuitem price: </label>
                                <input id="menuitemEditPrice" type="number" class="rounded border-2 m-2">
                                <select>
                                    <option id="locationId" v-for="location in locations">
                                        {{ location.id + " " + location.name }}
                                    </option>
                                </select>
                                <br>
                                ...
                                <label for="category" class="mt-4">Categorie</label>
                                ...
                                <button type="submit" class="bg-primary-500 text-white m-2 px-4 py-2 rounded">
                                    Edit locatie
                                </button>
                            </form>
                        </div>
